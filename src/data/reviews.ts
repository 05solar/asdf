...
const initialReviews: ReviewPost[] = [
  { id: "review-1", title: "한국에서의 추억이 이름과 카드로 남았어요.", content: "이름의 뜻을 함께 설명해 주셔서 여행이 끝난 뒤에도 특별한 기억으로 간직하고 있습니다.", author: "윤은재", authorEmail: "sample1@example.com", createdAt: "2026-08-01", applicantType: "personal", cardType: "honorary-korean", imageUrl: "/images/cards/main%20sec1%20ex1.png" },
  { id: "review-2", title: "행사 참가자에게 색다른 경험을 선물했습니다.", content: "신청부터 수령까지 과정이 명확했고, 참가자들의 만족도도 높아 다음 행사에서도 활용하고 싶습니다.", author: "문화행사 운영팀", authorEmail: "sample2@example.com", createdAt: "2026-07-28", applicantType: "organization", cardType: "honorary-citizen", imageUrl: "/images/cards/main%20sec1%20ex2.png" },
  { id: "review-3", title: "한국 문화를 자연스럽게 소개할 수 있었습니다.", content: "방문객 정보에 맞춘 카드가 행사 안내와 기념품 역할을 함께해 현장 반응이 좋았습니다.", author: "한문화교류원", authorEmail: "sample3@example.com", createdAt: "2026-07-21", applicantType: "organization", cardType: "visitor", imageUrl: "/images/cards/main%20sec2%20ex2.png" },
